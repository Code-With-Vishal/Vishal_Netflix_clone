...
const apiPaths = {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyCUO_iZ0vl_HRGpXNV9xH_GMddtXYsMjlY`
}
...
function buildBannerSection(movie) {
    ...
    div.innerHTML = `
            ...
            <p class="banner__overview">${movie.overview && movie.overview.length > 200 ? movie.overview+ '...' : movie.overview}</p>
